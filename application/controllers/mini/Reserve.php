...
class Reserve extends MY_Controller {
    ...
    public function listReserve() {
        ...
        $filed      = ['id', 'customer_id', 'room_type_id', 'name', 'phone',
            'visit_time', 'remark', 'status', 'employee_id', 'created_at'];
        ...
        $reserve     = Reserveordermodel::with('roomtype')->with('employee')
            ->where('store_id', $store_id)
            ->whereIn('status', ['WAIT', 'BEGIN'])
