...
//第三方授权相关Redis
define('COMPONENTVERIFYTICKT', 'FUNXDATA:CLOUD:EVENTS:TICKT');//微信推送ComponentVerifyTicket
define('ACCESSTOKEN', 'FUNXDATA:CLOUD:EVENTS:TOKEN');  //第三方AccessToken
define('PREAUTHCODE', 'FUNXDATA:CLOUD:EVENTS:PREAUTHCODE');//第三方预授权码
define('AUTHCODE', 'FUNXDATA:CLOUD:EVENTS:AUTHCODE');//第三方授权码
define('AUTHORACCESSTOKEN', 'FUNXDATA:CLOUD:EVENTS:AUTHORACCESSTOKEN');//第三方授权码
define('TICKETCOUNT', 'FUNXDATA:CLOUD:EVENTS:TICKETCOUNT');//TICKET
